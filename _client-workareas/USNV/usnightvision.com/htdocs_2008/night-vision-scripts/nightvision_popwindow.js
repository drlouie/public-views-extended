...
// Author: Louie Rod <drlouie@louierd.com>
...
function popWindow(url,name,w,h,closeit) {
	if (window.open) {
		...
		alert('Your security and/or browser settings are not allowing our popup windows to function. Please make sure your security software and browser settings allow popup windows from our website.');
	}
}