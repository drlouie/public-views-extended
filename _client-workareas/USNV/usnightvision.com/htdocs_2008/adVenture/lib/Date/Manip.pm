...
sub ParseDateString {
 ...
 PARSE: {
    ...
    my($month)=$Lang{$L}{"Month"};
    my(%month)=%{ $Lang{$L}{"MonthH"} };
    my($week)=$Lang{$L}{"Week"};
    my(%week)=%{ $Lang{$L}{"WeekH"} };
    my($wom)=$Lang{$L}{"WoM"};
    my(%wom)=%{ $Lang{$L}{"WoMH"} };
    my($dom)=$Lang{$L}{"DoM"};
    my(%dom)=%{ $Lang{$L}{"DoMH"} };
    my($ampmexp)=$Lang{$L}{"AmPm"};
    my($timeexp)=$Lang{$L}{"Times"};
    my($now)=$Lang{$L}{"Now"};
    my($offset)=$Lang{$L}{"Offset"};
    my($zone)=$Zone{"zones"} . '(?:\s+|$)';
    my($day)='\s*'.$Lang{$L}{"Dabb"};
    my($mabb)='\s*'.$Lang{$L}{"Mabb"};
    my($wkabb)='\s*'.$Lang{$L}{"Wabb"};
    my($next)='\s*'.$Lang{$L}{"Next"};
    my($prev)='\s*'.$Lang{$L}{"Prev"};
    my($past)='\s*'.$Lang{$L}{"Past"};
    my($future)='\s*'.$Lang{$L}{"Future"};
    my($later)='\s*'.$Lang{$L}{"Later"};
    my($at)=$Lang{$L}{"At"};
    my($of)='\s*'.$Lang{$L}{"Of"};
    my($on)='(?:\s*'.$Lang{$L}{"On"}.'\s*|\s+)';

    my($last)='\s*'.$Lang{$L}{"Last"};
    my($hm)=$Lang{$L}{"SepHM"};
    my($ms)=$Lang{$L}{"SepMS"};
    my($ss)=$Lang{$L}{"SepSS"};
