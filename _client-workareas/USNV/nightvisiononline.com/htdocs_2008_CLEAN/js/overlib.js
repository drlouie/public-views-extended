...
if (typeof ol_bgcolor=='undefined') var ol_bgcolor="#326728";
...
if (typeof ol_vpos=='undefined') var ol_vpos=null;
...
function layerWrite(txt) {
	txt += "\n";
	if (olNs4) {
		var lyr = o3_frame.document.layers['overLibDiv'].document
		lyr.write(txt)
		lyr.close()
...
// Check position of cursor relative to overLibDiv DIVision; mouseOut function
function cursorOff() {
...
function createDivContainer(id,frm,zValue) {
	id = (id || 'overLibDiv'), frm = (frm || o3_frame), zValue = (zValue || 1000);
