...
(function() {
	...
	var scripts = HTMLArea._scripts = [ _editor_url + "myHtmlarea.js",

					    _editor_url + "dialog.js",

					    _editor_url + "popupwin.js",

					    _editor_url + "coolmenus4.js",

						_editor_url + "lang/" + _editor_lang + ".js" ];

	var scriptsB = HTMLArea._scripts = [_editor_url + "menuConstructor.js"];
	...
	for (var i2 = 1; i2 < scriptsB.length; ++i2) {
		var script2 = document.createElement("script");
		script2.src = scriptsB[i2];
...
HTMLArea.Config = function (textarea) {
...
this.version = "3.0";
	...
	this.toolbar = [
		...
		[ "bold", "italic", "underline", "strikethrough", "separator",
		  ...
		  "space", "separator", "forecolor", "hilitecolor", "separator", "space", 
	...
	this.fontname = {
		...
		"Book Antiqua":	   'book antiqua,courier,monospace',

		"Bookman Old":	   'bookman old,courier,monospace',

		"Century":	   'century,courier,monospace',

		"Century Gothic":	   'century gothic,courier,monospace',
		...
		"Marlett":	   'marlett,times new roman,times,serif',		

		"Modern":	   'modern,times new roman,times,serif',

		"Symbol":	   'tahoma,arial,helvetica,sans-serif',		
		...
		"Webdings":	   'webdings,arial,helvetica,sans-serif',		
...
HTMLArea.prototype._createToolbar = function () {
	...
	toolbar.style.width = editorWidth+2;
...
/// ADD ID to each image so that we may add focus as necessary from any part of the document.

/// Will be used to focus from drop down DHTML menu, onfocus the object being focused will execute its button commmand
...
HTMLArea.prototype._insertImage = function(image) {
	...
	this._popupDialog("insert_image.html?queryURL=" + queryURL + "&siteID=" + siteID, function(param) {
