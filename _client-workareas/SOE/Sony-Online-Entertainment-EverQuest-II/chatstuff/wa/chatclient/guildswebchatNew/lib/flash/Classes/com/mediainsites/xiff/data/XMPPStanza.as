...
import com.mediainsites.xiff.data.IExtendable;
import com.mediainsites.xiff.data.IExtension;

import com.mediainsites.xiff.data.Extension;
import com.mediainsites.xiff.data.ExtensionContainer;
import com.mediainsites.xiff.data.ExtensionClassRegistry;

import com.mediainsites.xiff.data.XMLStanza;

import com.mediainsites.xiff.data.id.IncrementalGenerator;
import com.mediainsites.xiff.data.id.IIDGenerator;
 ...
 * @toc-sort 1/2
 */
class com.mediainsites.xiff.data.XMPPStanza extends XMLStanza implements ISerializable, IExtendable
{
	 ...
	 *
	 * @see com.mediainsites.xiff.data.id.IncrementalGenerator
	 * @availability Flash Player 7
	...
	{
		return theIDGenerator.getID( prefix );
	}
	 ...
	 * ID generators that have already been implemented (see com.mediainsites.xiff.data.id.*).
	 * 
	 ...
	 * class found in com.mediainsites.xiff.data.id.IncrementalGenerator:
	 * <pre>Message.setIDGenerator( com.mediainsites.xiff.data.id.IncrementalGenerator );</pre>
	 */
	public static function setIDGenerator( generator:IIDGenerator ):Void
	{
		theIDGenerator = generator;
	}
	...
	public function deserialize( xmlNode:XMLNode ):Boolean
	{
		...
		for( var i in children )
		{
			...
			if( nName == "error" ) {
				...
				var extClass:Object = ExtensionClassRegistry.lookup(nNamespace);
				if (extClass != null) {
