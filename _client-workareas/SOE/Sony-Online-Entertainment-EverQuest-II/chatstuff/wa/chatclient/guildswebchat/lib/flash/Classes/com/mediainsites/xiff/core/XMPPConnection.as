...
import com.mediainsites.xiff.data.IExtension;

import com.mediainsites.xiff.data.XMPPStanza;
import com.mediainsites.xiff.data.IQ;
import com.mediainsites.xiff.data.Message;
import com.mediainsites.xiff.data.Presence;
import com.mediainsites.xiff.data.auth.AuthExtension;
import com.mediainsites.xiff.data.register.RegisterExtension;
import com.mediainsites.xiff.data.ExtensionClassRegistry;

import com.mediainsites.xiff.exception.SerializationException;

import com.mediainsites.xiff.utility.ListenerXMLSocket;
 ...
 *
 * @availability Flash Player 7
 * @see com.mediainsites.xiff.data.Presence
 */
[Event("presence")]
 ...
 * @toc-sort 1
 */
class com.mediainsites.xiff.core.XMPPConnection
{
	 ...
	 * @see com.mediainsites.xiff.data.ISerializable
	...
	public function send( o:XMPPStanza ):Void
	{
		if( isActive() ) {
			if( o instanceof IQ ) {
				...
				addIQCallbackToPending( o.id, IQ(o).callbackName, IQ(o).callbackScope );
			}
	 ...
	 * @see com.mediainsites.xiff.core.XMPPConnection#isLoggedIn
	 */
	 ...
	 * @see com.mediainsites.xiff.core.XMPPConnection#isActive
	 */
	...
	private function socketReceivedData( data ):Void
	{
		...
		var eventObj:Object = {target:this, type:"incomingData", data:xmlData}
		dispatchEvent( eventObj );
	...
	private function handleStream( node:XMLNode ):Void
	{
		...
		// If a username is defined, then login, else get registration fields
	...
	private function addIQCallbackToPending( id, callbackName, callBackScope ):Void
	{
		pendingIQs[id] = {methodName:callbackName, methodScope:callBackScope};
	}
