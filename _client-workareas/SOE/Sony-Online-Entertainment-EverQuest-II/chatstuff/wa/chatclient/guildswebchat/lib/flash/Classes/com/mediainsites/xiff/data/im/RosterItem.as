 ...
 * @see com.mediainsites.xiff.data.im.RosterExtension
 * @param parent The parent XMLNode
 * @toc-path Extensions/Instant Messaging
 * @toc-sort 1/2
 */
class com.mediainsites.xiff.data.im.RosterItem extends XMLStanza implements ISerializable
{
